...
#ifndef AYNA_WATCHOS_WATCH_APP_SWIFT_H
#define AYNA_WATCHOS_WATCH_APP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Ayna_watchOS_Watch_App",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS("_TtC22Ayna_watchOS_Watch_App18GitHubOAuthService")
@interface GitHubOAuthService : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

/// WatchConnectivity service for the Watch app
/// Receives conversations from iPhone and sends new messages back
SWIFT_CLASS("_TtC22Ayna_watchOS_Watch_App24WatchConnectivityService")
...
@class WCSession;
@class NSString;
@interface WatchConnectivityService (SWIFT_EXTENSION(Ayna_watchOS_Watch_App)) <WCSessionDelegate>
